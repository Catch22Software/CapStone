...
print(len(df))  # length of initial hot-encoded pandas dataframe 3897
frequent_1 = apriori(df, min_support=0.0025654, use_colnames=True)  # support for at least 10 of the 3897 transactions
